...
//class RGBDOdometryNode :: public RGBDOdometryEngine {
//public:
//    typedef boost::shared_ptr<RGBDOdometryNode> Ptr;
//
//    RGBDOdometryNode() :
//    nodeptr(new ros::NodeHandle),
//    nh("~") {
...
//    // assignment operator.
//    // -------------------------
//    RGBDOdometryNode(const RGBDOdometryEngine& yRef);
//    RGBDOdometryNode& operator=(const RGBDOdometryEngine& yRef);
//
//    ros::NodeHandle nh;
//    ros::NodeHandlePtr nodeptr;
//
